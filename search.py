...
def graph_search(problem, fringe):
    ...
    while fringe:
        ...
        if problem.goal_test(node.state):
            print("Coste del camino:",contador)
            return node
...
def recorrido_y_profundidad(problem):
    return graph_search(problem, RYA())

def recorrido_y_profundidad_subestimacion(problem):
    return graph_search(problem,RYASubestimacion(problem))
